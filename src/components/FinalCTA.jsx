...
export default function FinalCTA() {
  ...
  return (
    <section className="section-pad py-20 md:py-24">
      <div className="section-max relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-navy-deep via-navy to-primary px-6 py-16 md:px-16 md:py-20">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.3fr_1fr] lg:items-center">
          <div>
            ...
            <Reveal as="h2" delay={60} className="mt-4 max-w-2xl text-[2rem] md:text-[3rem] font-semibold leading-[1.08] tracking-tight text-white">
              Ready to make your business <span className="gradient-text-light">smarter?</span>
            </Reveal>
            <Reveal delay={120} as="p" className="mt-5 max-w-xl text-[17px] leading-relaxed text-white/70">
          ...
          <Reveal delay={200} className="flex flex-col gap-3 sm:flex-row lg:flex-col lg:items-end">
            <button type="button" onClick={open} className="btn-primary justify-center !bg-white !text-navy hover:!bg-haze !px-8 !py-4">
              Book a Free Consultation <ArrowRight size={16} />
            </button>
            <a href={COMPANY.phoneHref} className="btn-ghost-light justify-center !px-8 !py-4">
